  ...
  return (
    ...
    >
      <div className="relative">
        <div className="relative h-8 w-16 rounded-full bg-slate-300 transition-all duration-300 dark:bg-zinc-800">
          ...
          <div
            className={`dark:bg-shamrock-400 absolute top-1 h-6 w-6 rounded-full bg-white transition-all duration-300 ${
