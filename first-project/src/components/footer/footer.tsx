...
export default function Footer() {
  ...
  return (
    <footer
      data-testid="footer"
      className="w-full bg-indigo-900 px-5 py-4 text-center text-white lg:px-20"
    >
      <div className="mx-auto flex max-w-[1440px] items-center justify-between">
        ...
        >
          ...
          <svg
            ...
            viewBox="0 0 24 24"
            className="h-5 w-5 fill-white transition-all duration-300 group-hover:fill-cyan-300"
          >
