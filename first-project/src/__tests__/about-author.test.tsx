...
test('AboutAuthor component renders with author information', () => {
  ...
  expect(description1).toHaveTextContent(useLocale().about.backgroundDescription[0]);

  const description2 = screen.getByTestId('about-author-description-2');
  expect(description2).toBeInTheDocument();
  expect(description2).toHaveTextContent(useLocale().about.backgroundDescription[1]);

  const description3 = screen.getByTestId('about-author-description-3');
  expect(description3).toBeInTheDocument();
  expect(description3).toHaveTextContent(useLocale().about.backgroundDescription[2]);
});
