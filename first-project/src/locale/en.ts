export const en = {
  ...
  error: {
    ...
    errorButton: 'Test error boundary',
  ...
  about: {
    ...
    learningJourneyTitle: 'React Course',
    ...
    rsSchoolButton: 'Join RS School React Course',
  },
  contacts: {
    title: 'Contact Me',
    linkedinName: 'Konstantin Petrov',
  ...
  cardDetail: {
    ...
    downloads: 'Downloads',
    views: 'Views',
    viewOnUnsplash: 'Open in Unsplash',
    close: 'Close',
    untitled: 'Untitled',
