...
export default function UncontrolledForm({ onSubmit }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      >
        <Select ref={genderRef} id="gender" className={inputClassName} dataTestId="gender-select">
      ...
      <div className="flex justify-end">
        <Button
          type="submit"
          className="w-full bg-yellow-300 hover:bg-yellow-400 dark:bg-cyan-500 dark:hover:bg-cyan-400"
